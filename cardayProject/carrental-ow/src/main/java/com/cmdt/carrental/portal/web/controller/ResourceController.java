...
public class ResourceController {
    ...
    public Map<String,Object> resourceList(@CurrentUser User loginUser) {
    	...
    	try{
     	   ...
     	   LOG.error("ResourceController[---resourceList---]", e);
	...
	@RequestMapping(value = "/showRoleResources", method = RequestMethod.POST)
    @ResponseBody
    public Map<String,Object> showRoleResources(@CurrentUser User loginUser, String json) {
    	Map<String,Object> map = new HashMap<String,Object>();
    	map.put("root", "");
    	try{
    		 Map<String, Object> jsonMap = JsonUtils.json2Object(json, Map.class);
    		 Long roleId = Long.valueOf(String.valueOf(jsonMap.get("roleId")));
    		 List<Resource> resources =  new ArrayList<Resource>();
    		 //超级管理员
    		 if(loginUser.isSuperAdmin()){
    		 ...
    		 map.put("status", "success");
    	     map.put("root", resourceService.formatList2TreeView(resources));
    	}catch(Exception e){
     	   LOG.error("ResourceController[---showRoleResources---]", e);
    		 map.put("status", "failure");
    	}
        return map;
    }
...
//    		}
	        ...
	        map.put("status", "success");
	     	   ...
	     	   LOG.error("ResourceController[---appendChild---]", e);
			 map.put("status", "failure");
		}
        return map;
    }
...
//    		}
	        ...
	        map.put("status", "success");
	     	   ...
	     	   LOG.error("ResourceController[---update---]", e);
			 map.put("status", "failure");
		}
        return map;
    }
    ...
    public Map<String,Object> delete(@CurrentUser User loginUser,@PathVariable("id") Long id) {
    	...
    	try{
			...
			if(loginUser.isAdmin()){
	     	 ...
	     	 LOG.error("ResourceController[---delete---]", e);
			 map.put("status", "failure");
		}
        return map;
    }
