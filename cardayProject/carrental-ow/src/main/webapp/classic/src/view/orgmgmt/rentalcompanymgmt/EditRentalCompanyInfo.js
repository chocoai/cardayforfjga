Ext.define('Admin.view.orgmgmt.rentalcompanymgmt.EditRentalCompanyInfo',{
	extend: 'Ext.window.Window',	
    alias: "widget.editRentalCompanyInfo",
	title : '编辑租车公司信息',
	requires: [
        'Admin.view.orgmgmt.rentalcompanymgmt.AdvancedVType'
    ],
	controller: {
        xclass: 'Admin.view.orgmgmt.rentalcompanymgmt.ViewController'
    },
	
	id:'editRentalCompanyInfo',
	width: 400,
    layout: 'fit',
	...
	items:[{
		xtype:'form',
		reference: 'editRentalCompanyInfo',
		layout: {
            type: 'vbox', 
            align: 'stretch'
        },
		...
		items:[{
			...
			xtype: 'checkboxgroup',
			id:'businessTypeCheckGroupEditRental',
		...
		buttons : [{
					...
					disabled : true,
	                formBind : true,
					handler:'updateRentalCompanyInfo'
				},{
					text: '取消',
