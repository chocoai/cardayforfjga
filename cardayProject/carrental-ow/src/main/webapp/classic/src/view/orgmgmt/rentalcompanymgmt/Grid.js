Ext.define('Admin.view.orgmgmt.rentalcompanymgmt.Grid', {
...
/*                	   	   		var marginValue = this.width/2-20;                        
							...
							tooltip : '查看',
							iconCls : 'x-fa fa-eye',
							handler: 'checkRentalCompanyInfo'
						},{
							xtype : 'button',
							tooltip : '审核信息',
							...
							handler : 'editRentalCompanyInfo'
						},{
							xtype : 'button',
							tooltip : '资源',
							iconCls : 'x-fa fa-asterisk',
							handler : 'resourcesInfoRentalCompany'
						},{
							xtype : 'button',
							tooltip : '租赁',
							iconCls : 'x-fa fa-stop',
							handler : 'rentalInfoRentalCompany'
						},{
							xtype : 'button',
							tooltip : '用车额度',
