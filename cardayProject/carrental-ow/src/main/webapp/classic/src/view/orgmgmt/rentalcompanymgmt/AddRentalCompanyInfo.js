Ext.define('Admin.view.orgmgmt.rentalcompanymgmt.AddRentalCompanyInfo',{
	extend: 'Ext.window.Window',	
    alias: "widget.addRentalCompanyInfo",
	title : '新增租车公司信息',
	requires: [
	...
	items:[{
		xtype:'form',
		reference: 'addRentalCompanyInfo',
		layout: {
            type: 'vbox', 
            align: 'stretch'
        },
		...
		items:[{
			...
			xtype: 'checkboxgroup',
			id:'businessTypeCheckGroupAddRental',
