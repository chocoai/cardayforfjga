package com.cmdt.carday.microservice.common.model.response;
...
public enum MessageCode {
     ...
     * 前缀 0002
     */
    MONTH_LIMIT_LEFT_OVERDRAFT("0002_1", "月度余额不足"),
    RULE_UNSATISFACTORY("0002_2", "用车规则不满足"),
    ...
    VEHICLE_NUMBER_EXIST("0003_1","该车牌号已被绑定，请重新输入！"),
	...
	VEHICLE_NUMBER_ALREADY_BOUND("0005_5","该车牌号已经绑定！"),
