...
public class MessageCodePropertyConfigurer extends PropertyPlaceholderConfigurer {  
	private static final Logger LOG = Logger.getLogger(MessageCodePropertyConfigurer.class);
