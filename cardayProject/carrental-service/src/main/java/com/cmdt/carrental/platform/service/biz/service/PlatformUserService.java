...
public class PlatformUserService {
    ...
    public void changePassword(UserChangePasswDto userChangePasswDto) {
        try {
            ...
            if (userService.isValidPassword(oldPassword, loginUser)) {
                ...
                throw new ServerException(Constants.API_ERROR_MSG_OLDPASSWORD_ERROR);
            }
        } catch (ServerException e) {
            throw e;
        } catch (Exception e) {
    ...
    public void changeUserInfo(User loginUser, UserListDto userListDto) {
        try {
            ...
            String phone = userListDto.getPhone();
            String email = userListDto.getEmail();
            String realname = userListDto.getRealname() != null ? userListDto.getRealname() : user.getRealname();
    ...
    public UserLoginRetDto login(UserLoginDto dto) {
        ...
        if (user.getOrganizationId() != null) {
            ...
            if (!"3".equals(org.getStatus())) {
                throw new ServerException("账户被锁定");
            }
        }
...
//		Set<String> permissions = userService.findPermissions(dto.getUsername());
        ...
        return new UserLoginRetDto(user, roles, permissionTree);
    }
