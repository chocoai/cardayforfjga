...
//	 @Autowired
//	 private AliDayuSmsService smsService;
	
	@Autowired
	private CommunicationService commuicationService;
...
//		    new ServiceAdapter(shouqiService).doService(ActionName.SMSMESSAGE, new Object[] { phoneNumber,"您在CarDay请求的验证码是: "+randNum });
			...
			commuicationService.sendSms(msgContent, phoneNumber);
...
//	    	}
	...
	public String resetPage(String phoneNumber, String flag, HttpServletRequest req) {
		if (flag.equals("gh")) {
			return "gehua_login/gh_getpass_resetPassword";
		} else {
