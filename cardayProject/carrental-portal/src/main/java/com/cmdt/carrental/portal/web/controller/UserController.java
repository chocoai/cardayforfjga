...
public class UserController extends BaseController{
    ...
    public Map<String,Object> list(@CurrentUser User loginUser,String json) {
    	...
    	try{ 
    		...
    		LOG.error("UserController.list",e);
    ...
    public Map<String,Object> listOrgAdminListByOrgId(@CurrentUser User loginUser,String json) {
    	...
    	try{ 
    		...
    		LOG.error("UserController.listOrgAdminListByOrgId",e);
    		 map.put("status", "failure");
    	}
        return map;
    }
    ...
    public Map<String,Object> findByName(String json) {
    	...
    	try{
    		...
    		LOG.error("UserController.findByName",e);
    		 map.put("status", "failure");
    	}
        return map;
    }
    ...
    public Map<String,Object> showUpdateForm(@PathVariable("id") Long id, Model model) {
    	...
    	try{
    		...
    		LOG.error("UserController.showUpdateForm",e);
    		 map.put("status", "failure");
    	}
        return map;
    }
    ...
    public Map<String,Object> listDirectUserListByOrgId(@CurrentUser User loginUser,String json) {
    	...
    	try{ 
    		...
    		LOG.error("UserController.listDirectUserListByOrgId",e);
    		 map.put("status", "failure");
    	}
        return map;
    }
    ...
    public Map<String,Object> listEnterpriseRootNodeUserList(@CurrentUser User loginUser) {
    	...
    	try{ 
    		...
    		LOG.error("UserController.listEnterpriseRootNodeUserList",e);
    		 map.put("status", "failure");
    	}
        return map;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/removeUserToEnterpriseRootNode",method = RequestMethod.POST)
    @ResponseBody
    public Map<String,Object> removeUserToEnterpriseRootNode(@CurrentUser User loginUser,String json) {
    	...
    	try{ 
    		...
    		LOG.error("UserController.removeUserToEnterpriseRootNode",e);
    		 map.put("status", "failure");
    	}
        return map;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/batchChangeUserOrganization",method = RequestMethod.POST)
    @ResponseBody
    public Map<String,Object> batchChangeUserOrganization(@CurrentUser User loginUser,String json) {
    	...
    	try{ 
    		...
    		LOG.error("UserController.batchChangeUserOrganization",e);
    		 map.put("status", "failure");
    	}
        return map;
    }
    ...
    public Map<String,Object> changeUserInfo(@CurrentUser User loginUser,String json) {
    	...
    	try{
    		...
    		LOG.error("UserController.changeUserInfo",e);
    		 map.put("status", "failure");
    	}
        return map;
    }
		...
		try {
			...
			for (int numSheet = 0; numSheet < numberOfSheets; numSheet++) {
				...
				for (int rowNum = 1; rowNum <= hssfSheet.getLastRowNum(); rowNum++) {
					...
					User user = new User();
					HSSFCell cell0 = hssfRow.getCell(0);//用户姓名
					HSSFCell cell1 = hssfRow.getCell(1);//用户名
					HSSFCell cell2 = hssfRow.getCell(2);//手机号
					HSSFCell cell3 = hssfRow.getCell(3);//邮箱
					HSSFCell cell4 = hssfRow.getCell(4);//登录密码
					HSSFCell cell5 = hssfRow.getCell(5);//所属企业
					HSSFCell cell6 = hssfRow.getCell(6);//角色分配
					
					// 用户姓名(必填)
					if (cell0 != null) {
						user.setRealname(CsvUtil.getValue(cell0));
					}
					// 用户名(必填)
					if (cell1 != null) {
						user.setUsername(CsvUtil.getValue(cell1));
					}
					// 手机号
					if (cell2 != null) {
						user.setPhone(CsvUtil.getValue(cell2));
					}
					// 邮箱
					if (cell3 != null) {
						user.setEmail(CsvUtil.getValue(cell3));
					}
					// 登录密码
					if (cell4 != null) {
						user.setPassword(CsvUtil.getValue(cell4));
					}
					// 所属企业(必填)
					if (cell5 != null) {
						user.setOrganizationName(CsvUtil.getValue(cell5));
					}
					// 角色分配(必填)
					if (cell6 != null) {
						user.setRoleName(CsvUtil.getValue(cell6));
					}
					modelList.add(user);
				}
			}
