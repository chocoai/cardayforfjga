...
<%@taglib prefix="carrentalfn" uri="http://cmdt.com/tags/carrental-functions" %>
<html>
<head>
    <title></title>
...
<body>
    ...
    <form:form method="post" commandName="role">
        ...
        <div class="form-group">
            ...
            <input type="text" id="resourceName" name="resourceName" value="${carrentalfn:resourceNames(role.resourceIds)}" readonly>
    ...
    <script>
        $(function () {
            ...
            var zNodes =[
                ...
                { id:${r.id}, pId:${r.parentId}, name:"${r.name}", checked:${carrentalfn:in(role.resourceIds, r.id)}},
                </c:if>
                </c:forEach>
            ];
