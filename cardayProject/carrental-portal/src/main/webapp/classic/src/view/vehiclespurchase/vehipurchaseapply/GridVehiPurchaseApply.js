Ext.define('Admin.view.vehiclespurchase.vehipurchaseapply.GridVehiPurchaseApply', {
	extend : 'Ext.grid.Panel',
	reference: 'gridVehiPurchaseApply',
	requires : [
	...
	title : '车辆购置申请中列表',
    bind:{
    	store:'{vehiPurchaseApplyResults}'
    },
    ...
    actions: {
        view: {
            tooltip : '查看',
			iconCls : 'x-fa fa-eye',
			handler: 'viewVehiPurchaseApply'
        },
        modify: {
            tooltip : '修改',
			iconCls : 'x-fa fa-edit',
            handler: 'updateVehiPurchaseApply'
        },
        approvalProcess: {
            tooltip : '审批流程',
