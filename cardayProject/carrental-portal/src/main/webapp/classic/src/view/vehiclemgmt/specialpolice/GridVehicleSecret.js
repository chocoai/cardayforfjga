Ext.define('Admin.view.vehiclemgmt.specialpolice.GridVehicleSecret', {
	extend : 'Ext.grid.Panel',
	reference: 'gridVehicleSecret',
	requires : [
		'Ext.grid.column.Action'
	],

    id:'gridVehicleSecret',
	title : '已涉密车辆列表',
    bind:{
    	store:'{vehiSecretResults}'
    },
        ...
        items:[
          {
            ...
            align: 'center',
            menuDisabled: true,
            items: ['@view', '@modifyTrafficPkg', '@modifySecret', '@modifyNoApprove']
          }]},
	dockedItems : [{
			id:'vehiSecretPage',
			pageSize:10,
