 ...
 */
Ext.define('Admin.view.reportmgmt.driversalary.ViewController', {
	extend : 'Ext.app.ViewController',
	requires : [
	        'Ext.window.MessageBox',
			'Admin.view.reportmgmt.driversalary.View',
			'Admin.view.reportmgmt.driversalary.SearchForm',
			],
...
//		var VehicleStore = this.lookupReference('driverSalaryGrid').getStore();
//		VehicleStore.currentPage = 1;
//		this.getViewModel().getStore("driverSalaryGridStore").load();
...
//		parm.numPerPage = Ext.getCmp('grid_driver_store_id').store.pageSize;
		...
		this.getViewModel().getStore("driverSalaryGridStore").proxy.extraParams = {
			"json" : input
		},
		this.getViewModel().getStore("driverSalaryGridStore").load();
	},
	...
	openDeptChooseWin: function(combo, event, eOpts){
     	var win = Ext.create("Admin.view.reportmgmt.driversalary.DeptChooseWin",{
  	...
  	chooseDept: function(btn, e, eOpts){
     	...
     	var form = Ext.getCmp("driversalarySearchForm").getForm();
