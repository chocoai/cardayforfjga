Ext.define('Admin.view.systemconfiguration.vehPurchaseConfiguration.UpdateVehPurchase', {
	extend : 'Ext.window.Window',
	requires : ['Ext.form.Panel',
				'Admin.view.systemconfiguration.vehPurchaseConfiguration.ViewController',
				'Admin.view.systemconfiguration.vehPurchaseConfiguration.ViewModel'
	],
	controller : {
