Ext.define('Admin.view.vehiclespurchase.vehipurchaseapply.GridVehiPurchaseRefuse', {
	extend : 'Ext.grid.Panel',
	reference: 'gridVehiPurchaseRefuse',
	requires : [
	...
	title : '车辆购置已驳回列表',
    bind:{
    	store:'{vehiPurchaseRefuseResults}'
    },
    ...
    actions: {
        view: {
            tooltip : '查看',
			iconCls : 'x-fa fa-eye',
			handler: 'viewVehiPurchaseRefuse'
        },
        modify: {
            tooltip : '修改',
			iconCls : 'x-fa fa-edit',
            handler: 'updateVehiPurchaseRefuse'
        },
        approvalProcess: {
            tooltip : '审批流程',
            iconCls : 'x-fa fa-reply',
            handler: 'approvalProcess'
        }
    },
    columns:[
          {
            ...
            align: 'center',
            menuDisabled: true,
            items: ['@view', '@modify', '@approvalProcess']
          }],
	dockedItems : [{
			id:'vehiPurchaseRefusePage',
			pageSize:10,
            xtype: 'pagingtoolbar',
            dock: 'bottom',
