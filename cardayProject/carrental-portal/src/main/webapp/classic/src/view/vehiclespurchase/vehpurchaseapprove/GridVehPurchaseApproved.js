Ext.define('Admin.view.vehiclespurchase.vehpurchaseapprove.GridVehPurchaseApproved', {
	extend : 'Ext.grid.Panel',
	reference: 'gridVehPurchaseApproved',
	requires : [
	...
	title : '车辆购置已审核列表',
    bind:{
    	store:'{vehiPurchaseApprovedResults}'
    },
    ...
    actions: {
        view: {
            tooltip : '查看',
			iconCls : 'x-fa fa-eye',
			handler: 'viewVehiPurchaseApproved'
        },
    },
    columns:[
          {
