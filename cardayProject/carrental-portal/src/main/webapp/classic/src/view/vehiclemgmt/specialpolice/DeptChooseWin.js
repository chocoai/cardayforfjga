 ...
 */
Ext.define('Admin.view.vehiclemgmt.specialpolice.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'specialPoliceChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
        id:'specialPoliceChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
                    var deptId = Ext.getCmp("specialPoliceChooseDeptWin").deptId;
                    if(deptId == null){
                        return;
                    }
                    
                    var tree = Ext.getCmp("specialPoliceChooseDeptWinTree");
                    if(tree == null){
                        return;
                    }
