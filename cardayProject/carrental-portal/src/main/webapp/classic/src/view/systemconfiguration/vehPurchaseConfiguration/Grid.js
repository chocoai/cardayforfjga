Ext.define('Admin.view.systemconfiguration.vehPurchaseConfiguration.Grid', {
	extend : 'Ext.grid.Panel',
	reference: 'gridVehPurchaseConfiguration',
	requires : [
		'Ext.grid.column.Action'
	],
	id: 'gridVehPurchaseConfiguration',
	title : '购置审批设置列表',
    bind:{
    	store:'{vehPurchaseResults}'
    },
    ...
    actions: {
        view: {
            tooltip : '查看',
			iconCls : 'x-fa fa-eye',
			handler: 'viewVehPurchase'
        },
        modify: {
            tooltip : '修改',
			iconCls : 'x-fa fa-edit',
            handler: 'updateVehPurchase'
        },
        delete: {
            tooltip : '删除',
            iconCls : 'x-fa fa-close',
            handler: 'deleteVehPurchase'
        }
    },
	columns:{
		defaults:{
