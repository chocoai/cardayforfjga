Ext.define('Admin.view.rulemgmt.ruleinfomgmt.AddRuleInfo', {
	extend: 'Ext.window.Window',
	
    alias: "widget.addRuleInfo",
    id: 'addRuleInfo',
    controller: 'ruleinfomgmtcontroller',
	reference: 'addRuleInfo',
	title : '新增用车规则',
	width : 1000,
	//height: 355,
	minHeight: 355,
//	maxHeight: 460,
	...
	items : [{
					...
					items: [
					{
						...
						layout: 'hbox',
						fieldLabel: '用车规则名称',
						//把fieldLabel放在这里是因为：测试要求左边对其，而这里使用的form layout会把label的位置空出来。所以在这里加field label。
						//新增修改同上。
						items: [
	                            {
//									fieldLabel: '用车规则名称',
