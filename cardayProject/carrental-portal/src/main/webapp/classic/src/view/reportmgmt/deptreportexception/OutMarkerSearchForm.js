 ...
 */
Ext.define('Admin.view.reportmgmt.deptreportexception.OutMarkerSearchForm', {
    ...
    reference: 'outMarkerSearchForm',
    id: 'outMarkerSearchFormId',
    bodyPadding: 1,
    header: false,
    fieldDefaults: {
        labelWidth: 65,
