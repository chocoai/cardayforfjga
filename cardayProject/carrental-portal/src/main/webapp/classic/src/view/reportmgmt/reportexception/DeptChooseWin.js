 ...
 */
Ext.define('Admin.view.reportmgmt.reportexception.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'reportExceptionChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
        id:'reportExceptionChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
                    var deptId = Ext.getCmp("reportExceptionChooseDeptWin").deptId;
                    if(deptId == null){
                        return;
                    }
                    
                    var tree = Ext.getCmp("reportExceptionChooseDeptWinTree");
                    if(tree == null){
                        return;
                    }
