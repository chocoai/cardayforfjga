...
Ext.define('Admin.view.orgmgmt.arcmgmt.deptmgmt.driverManage.GridAvailableAssignDriver', {
	...
	id: 'gridAvailableAssignDriver',
	reference: 'gridAvailableAssignDriver',
	AllSelectedUnAssignedRecords: new Array(),
	title : '可分配司机列表',
	bind : {
		store : '{availableAssignDriverStore}'
	},
	viewConfig: {
        loadMask: true,
        loadingText: '加载中...'
