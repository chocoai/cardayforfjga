 ...
 */
Ext.define('Admin.view.reportmgmt.deptreportexception.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'deptReportExceptionChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
        id:'deptReportExceptionChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
                    var deptId = Ext.getCmp("deptReportExceptionChooseDeptWin").deptId;
                    if(deptId == null){
                        return;
                    }
                    
                    var tree = Ext.getCmp("deptReportExceptionChooseDeptWinTree");
                    if(tree == null){
                        return;
                    }
