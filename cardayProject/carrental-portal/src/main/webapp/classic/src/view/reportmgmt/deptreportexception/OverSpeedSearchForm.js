 ...
 */
Ext.define('Admin.view.reportmgmt.deptreportexception.OverSpeedSearchForm', {
    ...
    reference: 'overSpeedSearchForm',
    id: 'overSpeedSearchFormId',
    bodyPadding: 1,
    header: false,
    fieldDefaults: {
        labelWidth: 65,
