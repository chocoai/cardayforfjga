Ext.define('Admin.view.reportmgmt.reportexception.AverageOverspeedAlarm', {
    ...
    items:[
      {
       xtype: 'cartesian',
	   id: 'averageOverspeedAlarmText',
       animate: true,
	   bind: {
		   store: '{averageOverspeedAlarm}'
	   },
