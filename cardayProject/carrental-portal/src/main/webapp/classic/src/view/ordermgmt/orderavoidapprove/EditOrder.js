Ext.define('Admin.view.ordermgmt.orderavoidapprove.EditOrder', {
	extend: 'Ext.window.Window',
	
    alias: "widget.avoidapproveEditOrderWin",
	...
	items : [{
        ...
        {
			id: 'edit_orderavoidapprove_orderUser_id',
			fieldLabel: '用车人',
			name: 'orderUser',
		    xtype: 'combo',
		    afterLabelTextTpl : ['<span style="color:red;font-weight:bold" data-qtip="Required">*</span>'],
        ...
        { 
      		id: 'edit_orderavoidapprove_orderUserphone_id',  
		    afterLabelTextTpl : ['<span style="color:red;font-weight:bold" data-qtip="Required">*</span>'],  		
		    xtype: 'displayfield',
      		fieldLabel: '电话',
			name: 'orderUserphone',
        ...
        { 
      		id: 'edit_orderavoidapprove_orderUserOrganizationId_id',
        	fieldLabel: '用车人组织Id',
			xtype: 'textfield',
			name: 'organizationId',
			hidden: true
		...
		{
			id: 'edit_orderavoidapprove_vehicle_id',
			afterLabelTextTpl : ['<span style="color:red;font-weight:bold" data-qtip="Required">*</span>'],
			fieldLabel: '车牌号',
			name: 'vehicleNumber',
		    xtype: 'combo',
