 ...
 */
Ext.define('Admin.view.vehiclemgmt.mantainance.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'mantainanceChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
        id:'mantainanceChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
                    var deptId = Ext.getCmp("mantainanceChooseDeptWin").deptId;
                    if(deptId == null){
                        return;
                    }
                    
                    var tree = Ext.getCmp("mantainanceChooseDeptWinTree");
                    if(tree == null){
                        return;
                    }
