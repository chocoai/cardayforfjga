Ext.define('Admin.view.systemconfiguration.vehSendConfiguration.Grid', {
	extend : 'Ext.grid.Panel',
	reference: 'gridVehSendConfiguration',
	requires : [
		'Ext.grid.column.Action'
	],
	id: 'gridVehSendConfiguration',
	title : '派车审批设置列表',
    bind:{
    	store:'{vehSendResults}'
    },
    ...
    actions: {
        ...
        modify: {
            ...
            handler: 'updateVehSend'
        },
        delete: {
            tooltip : '删除',
            iconCls : 'x-fa fa-close',
            handler: 'deleteVehSend'
        }
    },
	columns:{
		defaults:{
