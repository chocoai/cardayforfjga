 ...
 */
Ext.define('Admin.view.alertMgmt.violateAlarm.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'violateAlarmChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
    	id:'violateAlarmChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
            		var deptId = Ext.getCmp("violateAlarmChooseDeptWin").deptId;
            		if(deptId == null){
            			return;
            		}
            		
            		var tree = Ext.getCmp("violateAlarmChooseDeptWinTree");
            		if(tree == null){
            			return;
            		}
