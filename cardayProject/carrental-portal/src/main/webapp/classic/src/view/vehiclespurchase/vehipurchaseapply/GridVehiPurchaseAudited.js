Ext.define('Admin.view.vehiclespurchase.vehipurchaseapply.GridVehiPurchaseAudited', {
	extend : 'Ext.grid.Panel',
	reference: 'gridVehiPurchaseAudited',
	requires : [
	...
	title : '车辆购置审核通过列表',
    bind:{
    	store:'{vehiPurchaseAuditedResults}'
    },
    ...
    actions: {
        view: {
            tooltip : '查看',
			iconCls : 'x-fa fa-eye',
			handler: 'viewVehiPurchaseAudited'
        },
        approvalProcess: {
            tooltip : '审批流程',
    ...
    columns:[
          {
            ...
            align: 'center',
            menuDisabled: true,
            items: ['@view', '@approvalProcess']
          }],
	dockedItems : [{
			id:'vehiPurchaseAuditedPage',
			pageSize:10,
            xtype: 'pagingtoolbar',
            dock: 'bottom',
