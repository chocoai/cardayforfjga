 ...
 */
Ext.define('Admin.view.vehiclemgmt.vehiclemaintain.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'vehicleMaintainChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
        id:'vehicleMaintainChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
                    var deptId = Ext.getCmp("vehicleMaintainChooseDeptWin").deptId;
                    if(deptId == null){
                        return;
                    }
                    
                    var tree = Ext.getCmp("vehicleMaintainChooseDeptWinTree");
                    if(tree == null){
                        return;
                    }
