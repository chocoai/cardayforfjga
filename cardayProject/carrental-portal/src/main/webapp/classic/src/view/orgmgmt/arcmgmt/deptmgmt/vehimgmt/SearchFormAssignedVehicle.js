Ext.define('Admin.view.orgmgmt.arcmgmt.deptmgmt.vehimgmt.SearchFormAssignedVehicle', {
    ...
    id:'searchFormAssignedVehicle',

    reference: 'searchFormAssignedVehicle',
    ...
    items: [
    {
        ...
        items : [{
                    ...
                    store: new Ext.data.Store({
                        ...
                        listeners:{    
                            load : function(store, records, options ){  
                                ...
                                if(Ext.getCmp("vehicleModelId") != null){
                                    Ext.getCmp("vehicleModelId").setValue(0);
                                }
                            },
                    ...
                    margin : '0 10 10 10',
                    text:'查询',
                    handler:'onSearchClickforAssignedVehicle',
                  },
                  {
                    xtype:'button',
                    margin : '0 10 10 10',
                    text:'重置',
                    handler:'onResetClickforAssignedVehicle',
                  }
                ],
            },{
                xtype: 'container',
                ...
                items: [{
                    xtype: "button",
                    text: "移除",
                    handler: "batchUnassignedVehicle",
                }]
            },],
