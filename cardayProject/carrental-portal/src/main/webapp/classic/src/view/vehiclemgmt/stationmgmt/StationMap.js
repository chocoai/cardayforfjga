Ext.define('Admin.view.vehiclemgmt.stationmgmt.StationMap', {
    extend: 'Ext.panel.Panel',
    // xtype: 'tracking-map-panel',
    requires: [
        'Admin.ux.MapPanel',
    ],
    reference: 'stationMap',
    itemId: 'panelStationMap',
    maxWidth: 1920,
    maxHeight: 1200,
...
//    autoScroll: true,
    ...
    initComponent: function() {
        ...
        me.items = [{
            xtype: 'mappanel',
            // xtype: 'panel',
            id: 'stationmapdis_bmappanel',
            reference: 'bmappanelStation',
            itemId: 'bmappanelStationMap',
            maxWidth: 1920,
            maxHeight: 1200,
            width: 820,
            height: 460,
