 ...
 */
Ext.define('Admin.view.vehiclemgmt.vehoilmgmt.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'vehoilmgmtChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
        id:'vehoilmgmtChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
                    var deptId = Ext.getCmp("vehoilmgmtChooseDeptWin").deptId;
                    if(deptId == null){
                        return;
                    }
                    
                    var tree = Ext.getCmp("vehoilmgmtChooseDeptWinTree");
                    if(tree == null){
                        return;
                    }
