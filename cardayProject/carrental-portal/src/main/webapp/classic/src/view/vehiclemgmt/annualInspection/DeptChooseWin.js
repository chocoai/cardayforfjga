 ...
 */
Ext.define('Admin.view.vehiclemgmt.annualInspection.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'annualInspectionChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
    	id:'annualInspectionChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
            		var deptId = Ext.getCmp("annualInspectionChooseDeptWin").deptId;
            		if(deptId == null){
            			return;
            		}
            		
            		var tree = Ext.getCmp("annualInspectionChooseDeptWinTree");
            		if(tree == null){
            			return;
            		}
