Ext.define('Admin.view.systemconfiguration.oCardConfiguration.UpdateOCard', {
	extend : 'Ext.window.Window',
	requires : ['Ext.form.Panel',
				'Admin.view.systemconfiguration.oCardConfiguration.ViewController',
				'Admin.view.systemconfiguration.oCardConfiguration.ViewModel'
	],
	controller : {
