 ...
 */
Ext.define('Admin.view.reportmgmt.reportnotused.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'reportNotUsedChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
        id:'reportNotUsedChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
                    var deptId = Ext.getCmp("reportNotUsedChooseDeptWin").deptId;
                    if(deptId == null){
                        return;
                    }
                    
                    var tree = Ext.getCmp("reportNotUsedChooseDeptWinTree");
                    if(tree == null){
                        return;
                    }
