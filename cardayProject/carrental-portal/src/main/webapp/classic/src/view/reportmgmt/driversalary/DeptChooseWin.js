 ...
 */
Ext.define('Admin.view.reportmgmt.driversalary.DeptChooseWin', {
	extend: 'Ext.window.Window',
	requires : [ 'Ext.form.Panel'
	],
	id:'driverSalaryChooseDeptWin',
	controller:{
    ...
    items: [{
    	xtype:'treepanel',
        id:'driverSalaryChooseDeptWinTree',
    	frame:false,
    	rootVisible:false,
...
//       	             successProperty: 'success'
            ...
            listeners : {
            	load:function(store, records, successful, eOpts){
                    var deptId = Ext.getCmp("driverSalaryChooseDeptWin").deptId;
                    if(deptId == null){
                        return;
                    }
                    
                    var tree = Ext.getCmp("driverSalaryChooseDeptWinTree");
                    if(tree == null){
                        return;
                    }
