Ext.define('Admin.view.systemconfiguration.policeCardConfiguration.UpdatePoliceCard', {
	extend : 'Ext.window.Window',
	requires : ['Ext.form.Panel',
				'Admin.view.systemconfiguration.policeCardConfiguration.ViewController',
				'Admin.view.systemconfiguration.policeCardConfiguration.ViewModel'
	],
	controller : {
